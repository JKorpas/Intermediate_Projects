...
from bet import Bookie
from machinery import Machine
...
if __name__ == '__main__':
    ...
    while False:
        ...
        if total_bet < deposit._deposit:
            ...
            print(
                f"Not enough money. Your current balance is {deposit._deposit}$")
            while True:
                ...
                if add_depo_or_change_bet == "i":
                    ...
                    print(
                        f"Your current deposit is equalt to: {deposit._deposit}$")
                    break
